...
import com.game1.levels.DebugLevel;
import com.game1.levels.GameLevel;
import com.game1.sheets.GameSheets;
...
public class GameProcessor implements Runnable {
	...
	public GameProcessor(GameManager gameManager) {
		initEngine(gameManager);
		initGame();
	}

	private void initEngine(GameManager gameManager) {
